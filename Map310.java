...
class Map310<K extends Comparable<? super K>,V> implements Map<K,V> {
	...
	*/
	...
	/**
	 * Method for finding a set of keys in the map O(N).
	 * @return the set of keys contained within the map object
	 */
	public Set<K> keySet() {
		Set<K> keys = new Set310<>();
	...
	/**
	 * method for finding values contained in the map O(N).
	 * @return a linked list of values in the map.
	 */
